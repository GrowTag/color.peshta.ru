...
$APPLICATION->SetTitle("ПЕШТА - Наши кейсы");
?>
<section class="cases-section-1">
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="cases-section-1__title">
                <h1>Наши кейсы</h1>
            </div>
        </div>
    </div>
</section>
<section class="cases-section-2">
    <div class="container">
        <div class="row">
            <?$APPLICATION->IncludeComponent("bitrix:news.list", "cases_list_more", Array(
                "FIRST_ELEMENT" => "N",
