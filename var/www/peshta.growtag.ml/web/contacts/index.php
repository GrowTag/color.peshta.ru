...
<div class="section-contacts">
    <div class="row">
        <div class="container-sm text-align-center">
            <h1 class="section__title">Контакты</h1><br/>
            <div class="row">
                <div class="col-md-4">
                    <ul>
                        <li>
                            ...
                            <i class="fas fa-envelope"></i>&nbsp;<a href="mailto:info@peshta.ru">info@peshta.ru</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <ul>
                        <li>
                            <b>Снабжение</b><br/>
                            <i class="fas fa-envelope"></i>&nbsp;<a href="mailto:snab-ofset@peshta.ru">snab-ofset@peshta.ru</a>
                        </li>
                ...
                <div class="col-md-4">
                    <ul>
                        <li>
                            <b>Бухгалтерия</b><br/>
                            <i class="fas fa-phone-alt"></i>&nbsp;Внутр. 111
                        </li>
                    </ul>
                </div>
            </div>
            <div class="row mt-5">
                <p style="width: 100%;font-size: 18px;"><b>Специалисты  департамента по работе с ключевыми клиентами</b></p>
                <div class="col-md-4">
                    <ul>
                        <li>
                            Анна Лушникова<br/>
                            <i class="fas fa-phone-alt"></i>&nbsp;Внутр. 110<br/>
                            <i class="fas fa-envelope"></i>&nbsp;<a href="mailto:lushnikova@peshta.ru">lushnikova@peshta.ru</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <ul>
                        <li>
                            ...
                            <i class="fas fa-envelope"></i>&nbsp;<a href="mailto:fedorova@peshta.ru">fedorova@peshta.ru</a>
                        </li>
                ...
                <div class="col-md-4">
                    <ul>
                        <li>
                            ...
                            <i class="fas fa-envelope"></i>&nbsp;<a href="mailto:fedorova@peshta.ru">drozdova@peshta.ru</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="row mt-5">
                <p style="width: 100%;font-size: 18px;"><b>Менеджер департамента оперативной полиграфии, печатей и штампов</b></p>
                <div class="col-md-12">
                    <ul>
                        <li>
                            Катерина Гордеева<br/>
                            <i class="fas fa-phone-alt"></i>&nbsp;Внутр. 104<br/>
                            <i class="fas fa-envelope"></i>&nbsp;<a href="mailto:gordeeva@peshta.ru">gordeeva@peshta.ru</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="row mt-5">
                <p style="width: 100%;font-size: 18px;"><b><i class="fas fa-map-marker-alt"></i>&nbsp;г.Ижевск, ул. Кирова, 113</b></p>
                <div class="col-md-12">
