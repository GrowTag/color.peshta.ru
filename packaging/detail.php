...
?>
<?$APPLICATION->IncludeComponent("bitrix:news.detail", "packaging_detail", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"DETAIL_URL" => "#SITE_DIR#/packaging/#ELEMENT_CODE#/",	// URL страницы детального просмотра (по умолчанию - из настроек инфоблока)
