...
<section class="support-section">
    ...
    <section class="support-section-content packaging-section">
        <div class="container">
            <div class="cases-elements-list row justify-content-center pt-4 pb-4">
                <?$APPLICATION->IncludeComponent("bitrix:news.list", "packaging_page_list", Array(
	"FIRST_ELEMENT" => "N",
		...
		"DETAIL_URL" => "#SITE_DIR#/packaging/#CODE#/",	// URL страницы детального просмотра (по умолчанию - из настроек инфоблока)
