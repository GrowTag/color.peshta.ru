...
<form action="<?=POST_FORM_ACTION_URI?>" method="POST">
    ...
    <div class="index-section-7__form-button mt-4">
        ...
        <input onclick="ym(65948923,'reachGoal','order');return true;" title="Нажимая 'Заказать расчет' вы соглашаетесь с политикой конфиденциальности." <?if(strlen($arResult["OK_MESSAGE"]) > 0 || isset($_GET['success'])):?>disabled<?endif;?> type="submit" name="submit" value="Заказать" class="white-button form-button"/>
    </div>
