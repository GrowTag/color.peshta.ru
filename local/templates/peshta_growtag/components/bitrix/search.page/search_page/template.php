...
<form action="" method="get" class="search-section__form search-form">
    <div class="container">
        <div class="row">
...
<?else:?>
	<input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" class="search-form__input" placeholder="Как сделать визитки?" />
<?endif;?>
<?if($arParams["SHOW_WHERE"]):?>
	<select name="where" class="search-select">
